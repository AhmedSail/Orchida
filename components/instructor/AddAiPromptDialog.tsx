...
export default function AddAiPromptDialog({
  active,
  setActive,
  sectionId,
  onSuccess,
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("/api/ai-prompts", {
        ...
        body: JSON.stringify({ ...formData, sectionId }),
      });

      if (res.ok) {
        Swal.fire("تم الحفظ", "تم إضافة البرومبت بنجاح", "success");
        setFormData({
          title: "",
          prompt: "",
          imageUrl: "",
      ...
      Swal.fire("خطأ", "فشل في حفظ البرومبت", "error");
    } finally {

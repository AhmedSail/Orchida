      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            <select
              className="h-9 px-3 rounded-xl bg-zinc-50 dark:bg-zinc-900 border border-blue-100 dark:border-blue-900/30 outline-none text-xs w-48"
              onChange={(e) => {
                ...
                <div className="space-y-3 py-4 border-y border-slate-50 dark:border-zinc-800">
                  ...
                  {user.phone && (
                    <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400">
                      ...
                      <a
                        href={`https://wa.me/${(user.phone.startsWith("05") &&
                        user.phone.length === 10
                          ? "970" + user.phone.substring(1)
                          : user.phone
                        ).replace("+", "")}${

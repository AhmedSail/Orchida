        ...
        >
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight">
              منـــــتـــــجــــــــــات{" "}
              <span className="text-primary italic">رائــــــــــــــجة</span>
            </h2>
            <p className="text-gray-500 mt-2 font-medium text-lg">
              تصفح أفضل المنتجات المختارة بعناية لأجلك
            </p>
          </div>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            {currentProducts.map((product, index) => (
              <motion.div
                ...
                className="group relative flex flex-col bg-white rounded-[2.5rem] p-4 border border-gray-100 shadow-xl shadow-gray-200/40 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-2 h-full"
              >
                <div className="relative w-full aspect-[4/5] rounded-4xl overflow-hidden mb-6 shrink-0 bg-gray-50">
                  {product.imageUrl ? (
                    <Image
                ...
                <div className="px-2 flex flex-col flex-1">
                  <h3 className="text-xl font-black text-gray-900 group-hover:text-primary transition-colors duration-300 uppercase tracking-tight line-clamp-1">
                    {product.name}
                  </h3>
                  <p className="text-gray-500 mt-3 line-clamp-3 text-sm leading-relaxed font-medium">
                    {product.description}
                  </p>
                  ...
                  <div className="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between gap-4">
                    ...
                    {product.link && (
                      <Link
                        href={product.link}
                        target="_blank"
                        className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2.5 rounded-2xl text-[11px] font-black hover:bg-primary hover:text-white transition-all duration-300 whitespace-nowrap"
                      >
                        Aliexpress
